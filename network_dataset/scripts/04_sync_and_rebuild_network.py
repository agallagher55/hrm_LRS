...
also exists in QA, confirmed via Pro Catalog 2026-09-16 -- origin and
freshness unconfirmed, and it is not this script's source or anyone else's;
see 03_create_network_dataset.py's docstring for the same note.)
