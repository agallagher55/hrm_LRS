...
class DynSegFeature:
    ...
    def update_safe_school_streets(
        ...
        Audit fields are sourced from E_SafeSchoolStreets (the defining event
        for this view), joined on ROUTEID, mirroring how the speed limit
        neighbourhood view pulls audit dates from E_SpeedLimit. The source is
        the safe-school-streets-specific segmented feature generated by
